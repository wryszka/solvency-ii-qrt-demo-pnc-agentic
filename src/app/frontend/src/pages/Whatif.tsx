  ...
  return (
    <div className="max-w-5xl mx-auto p-6 space-y-5">
      <header className="flex items-start gap-3">
        ...
        <div className="flex-1">
          ...
          <p className="text-sm text-gray-500 mt-1">
            Pick a worked example. The standard-formula engine projects the capital impact live and
            the Contrarian Capital Reviewer fires automatically — a critical voice that pressure-tests
      ...
      <section className="bg-white border-2 border-blue-200 rounded-xl p-5 space-y-3">
        <span className="text-[11px] uppercase tracking-widest text-gray-500 font-bold">Pick a scenario — projects live</span>
