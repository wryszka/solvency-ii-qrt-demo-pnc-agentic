...
import { BookOpen, AlertTriangle, FileDown, ArrowLeft } from 'lucide-react';
...
export default function LifeReserving() {
  ...
  return (
    <div className="max-w-5xl mx-auto p-6 space-y-5">
      <WhatAmISeeing body="The life technical provisions — best-estimate liabilities plus risk margin by line of business, discounted on the risk-free curve. The starting point for life capital." />
      ...
      <ArtefactConnectionsPanel qrtId="reserving_life" />
      ...
      <ArtefactImpactPanel qrtId="reserving_life" />
    </div>
  );
}
