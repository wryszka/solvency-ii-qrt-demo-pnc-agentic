...
QRT_EXPORT_TABLES = {
    "s0602": "3_qrt_s0602_list_of_assets",
    "s0501": "3_qrt_s0501_premiums_claims_expenses",
    "s2501": "3_qrt_s2501_scr_breakdown",
    "s2606": "3_qrt_s2606_nl_uw_risk",
}
...
async def ensure_approvals_table() -> None:
    await execute_query(f"""
        CREATE TABLE IF NOT EXISTS {fqn('6_ai_approvals')} (
            approval_id STRING,
            qrt_id STRING,
