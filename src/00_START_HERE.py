...
# MAGIC ## Setup
# MAGIC
# MAGIC 1. Open **00_Generate_Data / bootstrap_archive** and run it
# MAGIC 2. Deploy the bundle: `databricks bundle deploy -t dev`
# MAGIC 3. Trigger the 4 QRT pipelines from the Workflows page
# MAGIC
# MAGIC ## Demo prep
# MAGIC
# MAGIC 1. Open **00_Generate_Data / inject_demo_gotchas** and run it
# MAGIC 2. Re-trigger S.05.01 and S.26.06 pipelines
# MAGIC 3. Open the app
# MAGIC
# MAGIC ## Demo scripts
# MAGIC
# MAGIC - **05_AI_Agents / demo_agent_eli5** — simplified version for recording
# MAGIC - **05_AI_Agents / demo_agent_walkthrough** — technical version with live code
# MAGIC - **05_AI_Agents / agentic_security_framework** — IT security & governance
# MAGIC
# MAGIC ## Full guide
# MAGIC
# MAGIC Open **00_Generate_Data / setup_guide_and_demo_script** for the complete
